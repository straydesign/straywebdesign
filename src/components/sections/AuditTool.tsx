...
export default function AuditTool() {
  ...
  return (
    <section id="teardown" className="py-20">
      <div className="mx-auto max-w-4xl px-5 md:px-8">
        <AnimateIn className="text-center">
          ...
          <p className="mt-4 text-lg text-text-secondary">
            I&apos;ll record a short teardown showing exactly what I&apos;d change
            and why. Start with the instant scan below — then drop your email at
            the bottom for the full walkthrough.
          </p>
        </AnimateIn>
            ...
            >
              ...
              <div className="text-center">
                <p className="font-mono text-base text-text-secondary">
                  {overallScore < 70
                    ? "That's leaving leads on the table. I can show you exactly where."
                    : overallScore < 90
                      ? "Decent scores — but scores aren't conversions. Let me show you what else is costing you leads."
                      : "Strong on speed. Now let's talk about whether it actually turns traffic into customers."}
                </p>
                <div className="mt-6">
                  <MagneticButton href="#contact" variant="primary" size="lg">
                    Send it — I&apos;ll record a teardown
                  </MagneticButton>
                </div>
                <p className="mt-3 font-mono text-xs text-text-tertiary">
                  Short screen recording walking through exactly what I&apos;d change — back in 24 hours.
                </p>
              </div>
            </motion.div>
          )}
