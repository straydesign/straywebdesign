...
export default function Results() {
  return (
    <section id="results" className="overflow-hidden border-y border-border-default bg-surface-page py-20 md:py-28" aria-label="Results">
          ...
          {RESULTS_METRICS.map((metric) => (
            <StaggerItem key={metric.label}>
              <div className="border-t border-border-strong pt-6">
                <div className="font-mono text-[clamp(3rem,8vw,5.5rem)] font-bold leading-none tracking-tighter text-text-primary">
                  <CountUp
                    value={metric.value}
                ...
                <p className="mt-3 font-mono text-[11px] font-semibold uppercase tracking-wider text-text-tertiary">
                  {metric.label}
                </p>
              </div>
            </StaggerItem>
