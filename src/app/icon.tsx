  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <img src={logoDataUri} width={24} height={12} />
        <span
          style={{
            fontSize: "5.5px",
            fontWeight: 700,
