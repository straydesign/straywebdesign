...
This is also where I usually come in, so here are my numbers where you can check them against your own phone log. A build runs between $500 and $3,000 depending on the size of the site, and a simple one takes about a week. After that, a monthly between $20 and $100 covers hosting with small edits included. At this stage of a business, that math either clears or it does not, and your call volume is the evidence either way.
...
At that point the question is no longer whether you can maintain the site yourself. You clearly can, since you have been doing it. The question is whether your evenings are the cheapest way to get the work done, and for a busy owner they rarely are. On my plans, changes bigger than the included small edits are billed by the hour, and an hour of mine tends to replace an evening of yours.
...
If you counted zero, you are early. The free profile plus a plain page is the right spend, and a designer's number can live in a drawer for later. Anyone who tells you otherwise is selling past the point where the product helps, and you should hold on to your money until it has real work to do.
