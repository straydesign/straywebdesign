...
Google's own research found bounce probability increases 32% when load time goes from 1 to 3 seconds. Rakuten 24's A/B test showed improved Core Web Vitals delivered a 53.4% jump in revenue per visitor. The Deloitte/Google study found a 0.1-second improvement increased retail conversions by 8.4%. The performance gap between these two platforms directly translates to a conversion gap.
...
What we can say without equivocation: the performance data is not close. The security data is not close. And for businesses where conversion rate directly impacts revenue, those gaps have a dollar value that compounds every month your site is live. Understand what [Core Web Vitals](/resources/blog/core-web-vitals-explained-for-practices-and-firms) mean for your bottom line before you make the call.