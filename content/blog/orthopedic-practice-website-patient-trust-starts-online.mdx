...
When your [site takes too long to load](/resources/blog/website-performance-optimization-speed) — Portent's research shows conversion rates drop from 3.05% at 1 second to 1.08% at 5 seconds — each one of those bounced visitors could have been worth tens of thousands of dollars. And unlike a restaurant where a lost customer means a $40 dinner, a lost orthopedic patient means $50,000-$100,000 you'll never see.
