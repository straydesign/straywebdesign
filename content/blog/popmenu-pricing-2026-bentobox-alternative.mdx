...
None of that needs to cost $2,000 a year. My basic restaurant build is $500 flat, then $25 a month for hosting with small edits included: hours, photos, a price change, sent over and handled.

Menus update without me too. [Andy's Pub](https://andyspub.com) runs a daily specials board and full menus the team edits themselves, and [Bullfrog](https://bullfrogbarerie.com) keeps its live-music calendar current the same way. Both are live client sites; open them and poke around. If you want ordering, I've wired menus and payments through tools like Square and PayPal that charge per transaction instead of per month.

Bigger changes are $30 an hour, quoted first. I wrote up the honest math on one-time payments and the small costs every website carries in [the ownership breakdown](/resources/blog/one-time-payment-website-own-it-outright).

## The three-year comparison

Popmenu Starter with ordering runs about $2,750 a year, so call it $8,250 over three years for one location. My version is $500 once plus $25 a month, which is $1,400 over the same three years, with the menu updates that platform fee was supposed to cover already included.
