...
The Lindgaard et al. research demonstrated that users form aesthetic judgments about a website in 50 milliseconds. Stanford's Web Credibility Research Project found design quality is the primary factor in perceived trustworthiness. When every site in a market looks like a variation of the same Squarespace template — because they are — none of them stand out.
...
Forrester's UX research found that well-designed user interfaces can boost conversion rates by up to 200%. Unbounce's analysis of 41,000 landing pages found median conversion rates varying by 3-5x between well-optimized and poorly-optimized pages. The conversion gap between a template builder site and a professionally designed custom site isn't theoretical. It's measured, documented, and consistent.
