...
Web design pricing varies wildly because overhead varies wildly. Agency quotes for a small business site commonly land between $3,000 and $15,000, and a solo designer with no office and no account managers can do the same work for a fraction of that. The number itself tells you less than what stands behind it.

Red flag pricing patterns:
- **A price with no visible work behind it.** Whatever the number, ask to see live sites the designer built and still runs. A price attached to a real portfolio means something; a price attached to a template gallery does not.
...
For what it's worth, my own basic build is $500 flat plus $25 a month for hosting with small edits included, and the [live client sites on my home page](/#work) are what that buys. We break down the wider market numbers in our [cost comparison guide](/resources/blog/custom-website-cost-vs-template-real-numbers).
