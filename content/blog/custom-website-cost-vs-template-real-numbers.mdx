...
Orbit Media's annual web design survey consistently finds that the average website lifespan is under 3 years before a redesign, and DIY template sites tend to hit that wall sooner. The "cheap" DIY option has a pattern: it costs less to start and more to maintain, until the total cost of ownership exceeds what a custom build would have run.
...
- **Performance optimization:** $300-800 because [your Core Web Vitals are failing](/resources/blog/website-speed-optimization-guide-2026) and Google is penalizing you
...
Those are agency rates: for a typical small business site (5-15 pages), agencies quote $3,000-$8,000, and complex sites with custom functionality (booking systems, client portals, e-commerce) run $8,000-$15,000. A solo designer without agency overhead can land far below that range for the same class of build — my own basic build is $500 flat plus $25 a month for hosting with small edits included. The range mostly tells you who is billing, while the quality question is answered by the live sites a designer can show you.
