...
Google's data on mobile behavior is clear: 53% of mobile visitors leave a site that takes longer than 3 seconds to load. For emergency searches, that threshold is effectively lower — urgency makes people even less patient.
