...
The business case for accessibility goes beyond lawsuit avoidance. The CDC reports that 26% of US adults — roughly 61 million people — have a disability. That's not a niche market. The UK's Click-Away Pound Survey found that 69% of disabled consumers click away from websites with accessibility barriers, representing £17.1 billion in lost annual revenue.
...
WebAIM's Million analysis confirms the pattern across the broader web: 94.8% of top sites fail basic accessibility checks, with low-contrast text on 79% and missing alt text on 55.5%. The bar is low. But that means the businesses that clear it have a genuine competitive advantage — they get the customers everyone else turns away.
