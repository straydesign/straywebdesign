...
Two things changed. First, the store started showing up for the things it sells instead of only its own name. Someone searching for a specific species can now find out a store twenty minutes away carries it. The same catalog feeds Google's free local product listings, so items appear in search results as things you can walk in and buy.

Second, the phone calls changed shape. They used to start at "do you have..." and a lot of them now start at "I saw you have the one I want, I'm coming Saturday." The site answers the first question so the call can be the second one.
